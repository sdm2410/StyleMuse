    ...
    <>
      ...
      <main>
            ...
            {noticias.filter(n =>
              ...
              <div key={n.id} className="card1 border-dark shadow-lg p-3 mb-5 bg-body rounded" style={{ width: '18rem' }}>
                ...
                <div className="card-body bg-light text-dark">
                  ...
                  <a href="#" className="btn btn-secondary" title="Ir a comprar" onClick={(e) => {
                    e.preventDefault();
        ...
        <div className="tarjetas" id="moda">
          ...
          {/* Noticias dinámicas de Moda */}
          {noticias.filter(n => n.categoria.toLowerCase() === 'moda').map((n) => (
            <div key={n.id} className="card1 border-dark shadow-lg p-3 mb-5 bg-body rounded" style={{ width: '18rem' }}>
        ...
        <div className="tarjetas" id="pasarela">
          ...
          {/* Noticias dinámicas de Pasarelas */}
          {noticias.filter(n => n.categoria.toLowerCase() === 'pasarela').map((n) => (
            <div key={n.id} className="card1 border-dark shadow-lg p-3 mb-5 bg-body rounded" style={{ width: '18rem' }}>
        ...
        <div className="tarjetas" id="famosas">
          ...
          <div className="grid_cards3">
            ...
            {/* Noticias dinámicas de Famosas */}
            {noticias.filter(n => n.categoria.toLowerCase() === 'famosas').map((n) => (
              <div key={n.id} className="card1 border-dark shadow-lg p-3 mb-5 bg-body rounded" style={{ width: '18rem' }}>
          ...
          <div className="grid_cards3">
            ...
            <div className="card3 border-dark shadow-lg p-3 mb-5 bg-body rounded" style={{ width: '18rem' }}>
              ...
              <div className="card-body bg-light text-dark">
                ...
                <Link to="/noticia2"><a className="btn btn-secondary" title="Ir a comprar">Leer noticia</a></Link>
              </div>
            </div>
      ...
      {/* Botón de escritor y administrador que aparece solo para usuarios con el rol*/}
      <WriterButton />
      <AdminButton />
    </>
  );
